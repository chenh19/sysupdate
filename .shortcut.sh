...
[ -f /usr/share/applications/rstudio.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'R Development' --set-key 'GenericName[en_US]' --set-value 'R Development' --set-key 'GenericName[zh_CN]' --set-value 'R语言开发' \
    --set-generic-name 'R Programming IDE' --set-key 'Comment[en_US]' --set-value 'R Programming IDE' --set-key 'Comment[zh_CN]' --set-value 'R语言开发工具' \
...
[ -f /usr/share/applications/org.kde.kdevelop.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Integrated Development Environment' --set-key 'GenericName[en_US]' --set-value 'Integrated Development Environment' --set-key 'GenericName[zh_CN]' --set-value '集成开发环境' \
    --remove-key 'Categories' --add-category 'Development;' \
...
[ -f /usr/share/applications/sqlitebrowser.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'SQLite Database Tool' --set-key 'GenericName[en_US]' --set-value 'SQLite Database Tool' --set-key 'GenericName[zh_CN]' --set-value 'SQLite数据库管理工具' \
    --set-generic-name 'Open Source SQLite Database Browser' --set-key 'Comment[en_US]' --set-value 'Open Source SQLite Database Browser' --set-key 'Comment[zh_CN]' --set-value '开源数据库管理工具' \
    --remove-key 'Categories' --add-category 'Development;' \
...
[ -f /usr/share/applications/jupyterlab-desktop.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'JupyterLab Desktop' --set-key 'GenericName[en_US]' --set-value 'JupyterLab Desktop' --set-key 'GenericName[zh_CN]' --set-value 'JupyterLab桌面' \
    --set-generic-name 'JupyterLab Desktop Client' --set-key 'Comment[en_US]' --set-value 'JupyterLab Desktop Client' --set-key 'Comment[zh_CN]' --set-value 'JupyterLab桌面客户端' \
    --remove-key 'Categories' --add-category 'Development;' \
...
[ -f /usr/share/applications/virtualbox.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Virtualization Software' --set-key 'GenericName[en_US]' --set-value 'Virtualization Software' --set-key 'GenericName[zh_CN]' --set-value '虚拟机软件' \
    --set-generic-name 'Run virtual systems' --set-key 'Comment[en_US]' --set-value 'Run virtual systems' --set-key 'Comment[zh_CN]' --set-value '运行虚拟机' \
    --remove-key 'Categories' --add-category 'Development;' \
...
[ -f /usr/share/applications/clustalx.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Multiple Sequence Alignment' --set-key 'GenericName[en_US]' --set-value 'Multiple Sequence Alignment' --set-key 'GenericName[zh_CN]' --set-value '多重序列比对' \
    --set-generic-name 'Global Multiple Nucleotide or Peptide Sequence Alignment and Phylogenetic Analysis' --set-key 'Comment[en_US]' --set-value 'Global Multiple Nucleotide or Peptide Sequence Alignment and Phylogenetic Analysis' --set-key 'Comment[zh_CN]' --set-value '核酸与蛋白质序列比对工具' \
...
[ -f /usr/share/applications/fastqc.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Fast Quality Control' --set-key 'GenericName[en_US]' --set-value 'Fast Quality Control' --set-key 'GenericName[zh_CN]' --set-value '测序数据质检' \
    --set-generic-name 'Quality Control Tool for High Throughput Sequence Data' --set-key 'Comment[en_US]' --set-value 'Quality Control Tool for High Throughput Sequence Data' --set-key 'Comment[zh_CN]' --set-value '测序数据质量控制工具' \
...
[ -f /usr/share/applications/igv.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Integrative Genomics Viewer' --set-key 'GenericName[en_US]' --set-value 'Integrative Genomics Viewer' --set-key 'GenericName[zh_CN]' --set-value '基因组浏览器' \
    --set-generic-name 'High-performance Viewer for Large Genomics Datasets' --set-key 'Comment[en_US]' --set-value 'High-performance Viewer for Large Genomics Datasets' --set-key 'Comment[zh_CN]' --set-value '高性能的基因组可视化工具' \
...
[ -f /usr/share/applications/pymol.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Molecular Modeller' --set-key 'GenericName[en_US]' --set-value 'Molecular Modeller' --set-key 'GenericName[zh_CN]' --set-value '三维分子模型' \
    --set-generic-name 'Model Molecular Structures and Produce High-quality Images' --set-key 'Comment[en_US]' --set-value 'Model Molecular Structures and Produce High-quality Images' --set-key 'Comment[zh_CN]' --set-value '分子三维结构分析工具' \
...
[ -f /usr/share/applications/snapgene-viewer.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Everyday Molecular Biology' --set-key 'GenericName[en_US]' --set-value 'Everyday Molecular Biology' --set-key 'GenericName[zh_CN]' --set-value '分子生物学工具' \
    --set-generic-name 'View, Edit, and Analyze Sequences' --set-key 'Comment[en_US]' --set-value 'View, Edit, and Analyze Sequences' --set-key 'Comment[zh_CN]' --set-value '浏览，分析与编辑生物序列' \
...
[ -f /usr/share/applications/tropy.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Lab Image Manager' --set-key 'GenericName[en_US]' --set-value 'Lab Image Manager' --set-key 'GenericName[zh_CN]' --set-value '实验图片管理' \
    --set-generic-name 'Organizing and Annotating Experiment Images' --set-key 'Comment[en_US]' --set-value 'Organizing and Annotating Experiment Images' --set-key 'Comment[zh_CN]' --set-value '整理和标注实验图片' \
    --remove-key 'Categories' --add-category 'Science;' \
...
[ -f /usr/share/applications/zotero.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Bibliography Manager' --set-key 'GenericName[en_US]' --set-value 'Bibliography Manager' --set-key 'GenericName[zh_CN]' --set-value '文献管理' \
    --set-generic-name 'Organizing and Citing References' --set-key 'Comment[en_US]' --set-value 'Organizing and Citing References' --set-key 'Comment[zh_CN]' --set-value '管理和引用文献' \
    --remove-key 'Categories' --add-category 'Science;' \
    --remove-key 'Description' \
...
[ -f /usr/share/applications/chat-gpt.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Artificial Intelligence Chatbot' --set-key 'GenericName[en_US]' --set-value 'Artificial Intelligence Chatbot' --set-key 'GenericName[zh_CN]' --set-value '人工智能聊天机器人' \
    --remove-key 'Categories' --add-category 'Science;' \
...
[ -f /usr/share/applications/4kvideodownloaderplus.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment '4K Video Downloader' --set-key 'GenericName[en_US]' --set-value '4K Video Downloader' --set-key 'GenericName[zh_CN]' --set-value '4k网络视频下载工具' \
    --set-generic-name 'Download Videos from YouTube and Bilibili' --set-key 'Comment[en_US]' --set-value 'Download Videos from YouTube and Bilibili' --set-key 'Comment[zh_CN]' --set-value '下载YouTueb和Bilibili高清视频' \
...
[ -f /usr/share/applications/baidunetdisk.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Baidu Netdisk' --set-key 'GenericName[en_US]' --set-value 'Baidu Netdisk' --set-key 'GenericName[zh_CN]' --set-value '百度网盘' \
    --set-generic-name 'Baidu Netdisk Client' --set-key 'Comment[en_US]' --set-value 'Baidu Netdisk Client' --set-key 'Comment[zh_CN]' --set-value '百度网盘客户端' \
...
[ -f /usr/share/applications/securew2.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'SecureW2 Eduroam' --set-key 'GenericName[en_US]' --set-value 'SecureW2 Eduroam' --set-key 'GenericName[zh_CN]' --set-value 'Eduroam高校网络' \
    --set-generic-name 'Secure world-wide roaming wireless service for universities' --set-key 'Comment[en_US]' --set-value 'Secure world-wide roaming wireless service for universities' --set-key 'Comment[zh_CN]' --set-value '安全的全球高校无线网络漫游服务' \
...
[ -f /usr/share/applications/com.cisco.anyconnect.gui.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Cisco Anyconnect' --set-key 'GenericName[en_US]' --set-value 'Cisco Anyconnect' --set-key 'GenericName[zh_CN]' --set-value '思科AnyConnect' \
    --set-generic-name 'Connect to University Network' --set-key 'Comment[en_US]' --set-value 'Connect to University Network' --set-key 'Comment[zh_CN]' --set-value '连接校园网' \
    --remove-key 'Categories' --add-category 'Network;' \
...
[ -f /usr/share/applications/com.teamviewer.TeamViewer.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Remote Control Tool' --set-key 'GenericName[en_US]' --set-value 'Remote Control Tool' --set-key 'GenericName[zh_CN]' --set-value '远程控制工具' \
    --set-generic-name 'Remote Desktop Software' --set-key 'Comment[en_US]' --set-value 'Remote Desktop Software' --set-key 'Comment[zh_CN]' --set-value '远程桌面协助工具' \
...
[ -f /usr/share/applications/freedownloadmanager.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Free Download Manager' --set-key 'GenericName[en_US]' --set-value 'Free Download Manager' --set-key 'GenericName[zh_CN]' --set-value '下载管理工具' \
    --set-generic-name 'Powerful Modern Download Accelerator and Organizer' --set-key 'Comment[en_US]' --set-value 'Powerful Modern Download Accelerator and Organizer' --set-key 'Comment[zh_CN]' --set-value '高速下载与管理工具' \
    --remove-key 'Categories' --add-category 'Network;' \
...
[ -f /usr/share/applications/filezilla.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'FTP client' --set-key 'GenericName[en_US]' --set-value 'FTP client' --set-key 'GenericName[zh_CN]' --set-value 'FTP客户端' \
    --set-generic-name 'Download and upload files via FTP, FTPS and SFTP' --set-key 'Comment[en_US]' --set-value 'Download and upload files via FTP, FTPS and SFTP' --set-key 'Comment[zh_CN]' --set-value 'FTP,FTPS和SFTP客户端' \
    --remove-key 'Categories' --add-category 'Network;' \
...
[ -f /usr/share/applications/google-chrome.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Web Browser' --set-key 'GenericName[en_US]' --set-value 'Web Browser' --set-key 'GenericName[zh_CN]' --set-value '浏览互联网' \
    --set-generic-name 'Google Chrome Web Browser' --set-key 'Comment[en_US]' --set-value 'Google Chrome Web Browser' --set-key 'Comment[zh_CN]' --set-value '谷歌浏览器' \
    --remove-key 'Categories' --add-category 'Network;' \
...
[ -f /usr/share/applications/thunderbird.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Email Client' --set-key 'GenericName[en_US]' --set-value 'Email Client' --set-key 'GenericName[zh_CN]' --set-value '邮件客户端' \
    --set-generic-name 'Read/Write Mail/News with Thunderbird' --set-key 'Comment[en_US]' --set-value 'Read/Write Mail/News with Thunderbird' --set-key 'Comment[zh_CN]' --set-value '阅读邮件或新闻' \
...
[ -f /usr/share/applications/org.gnome.Evolution.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Groupware Suite' --set-key 'GenericName[en_US]' --set-value 'Groupware Suite' --set-key 'GenericName[zh_CN]' --set-value '个人管理工具' \
    --set-generic-name 'Manage your email, contacts and schedule' --set-key 'Comment[en_US]' --set-value 'Manage your email, contacts and schedule' --set-key 'Comment[zh_CN]' --set-value '管理个人邮件，联系人，日历' \
    --remove-key 'Categories' --add-category 'Network;' \
...
[ -f /usr/share/applications/slack.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Digital Headquarters' --set-key 'GenericName[en_US]' --set-value 'Digital Headquarters' --set-key 'GenericName[zh_CN]' --set-value '工作即时通讯' \
    --set-generic-name 'Stop slacking and get back to work!' --set-key 'Comment[en_US]' --set-value 'Stop slacking and get back to work!' --set-key 'Comment[zh_CN]' --set-value 'Slack工作即时通讯' \
    --remove-key 'Categories' --add-category 'Network;' \
...
[ -f /usr/share/applications/Zoom.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Video Conference' --set-key 'GenericName[en_US]' --set-value 'Video Conference' --set-key 'GenericName[zh_CN]' --set-value '视频会议' \
...
[ -f /usr/share/applications/eusoft-eudic.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Dictionary' --set-key 'GenericName[en_US]' --set-value 'Dictionary' --set-key 'GenericName[zh_CN]' --set-value '英语词典' \
    --set-generic-name 'The Best Dictionary Application' --set-key 'Comment[en_US]' --set-value 'The Best Dictionary Application' --set-key 'Comment[zh_CN]' --set-value '最好的开源词典软件' \
    --set-key 'StartupNotify' --set-value 'true' \
    --set-key 'Terminal' --set-value 'false' \
...
[ -f /usr/share/applications/libreoffice-base.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Database Development' --set-key 'GenericName[en_US]' --set-value 'Database Development' --set-key 'GenericName[zh_CN]' --set-value '数据库开发' \
    --set-generic-name 'Manage databases, create queries and reports to track and manage your information by using Base' --set-key 'Comment[en_US]' --set-value 'Manage databases, create queries and reports to track and manage your information by using Base' --set-key 'Comment[zh_CN]' --set-value '使用 Base 管理数据库并创建查询和报表，以对信息进行跟踪和管理' \
    --remove-key 'Categories' --add-category 'Office;' \
...
[ -f /usr/share/applications/libreoffice-calc.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Spreadsheet' --set-key 'GenericName[en_US]' --set-value 'Spreadsheet' --set-key 'GenericName[zh_CN]' --set-value '电子表格' \
    --set-generic-name 'Perform calculations, analyze information and manage lists in spreadsheets by using Calc' --set-key 'Comment[en_US]' --set-value 'Perform calculations, analyze information and manage lists in spreadsheets by using Calc' --set-key 'Comment[zh_CN]' --set-value '使用 Calc 进行计算，并在电子表格中进行数据分析' \
    --remove-key 'Categories' --add-category 'Office;' \
...
[ -f /usr/share/applications/libreoffice-draw.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Drawing Program' --set-key 'GenericName[en_US]' --set-value 'Drawing Program' --set-key 'GenericName[zh_CN]' --set-value '电子绘画' \
    --set-generic-name 'Create and edit drawings, flow charts and logos by using Draw' --set-key 'Comment[en_US]' --set-value 'Create and edit drawings, flow charts and logos by using Draw' --set-key 'Comment[zh_CN]' --set-value '使用 Draw 创建并编辑图形、流程图和徽标' \
    --remove-key 'Categories' --add-category 'Office;' \
...
[ -f /usr/share/applications/libreoffice-impress.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Presentation' --set-key 'GenericName[en_US]' --set-value 'Presentation' --set-key 'GenericName[zh_CN]' --set-value '演示文稿' \
    --set-generic-name 'Create and edit presentations for slideshows, meeting and Web pages by using Impress' --set-key 'Comment[en_US]' --set-value 'Create and edit presentations for slideshows, meeting and Web pages by using Impress' --set-key 'Comment[zh_CN]' --set-value '使用 Impress 创建并编辑幻灯片、会议和网页中使用的演示文稿' \
    --remove-key 'Categories' --add-category 'Office;' \
...
[ -f /usr/share/applications/libreoffice-startcenter.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Office Suite' --set-key 'GenericName[en_US]' --set-value 'Office Suite' --set-key 'GenericName[zh_CN]' --set-value '办公套件' \
    --set-generic-name 'The office productivity suite compatible to the open and standardized ODF document format' --set-key 'Comment[en_US]' --set-value 'The office productivity suite compatible to the open and standardized ODF document format' --set-key 'Comment[zh_CN]' --set-value '办公生产套件与开放、标准化的 ODF 文档格式兼容' \
    --remove-key 'Categories' --add-category 'Office;' \
...
[ -f /usr/share/applications/libreoffice-writer.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Word Processor' --set-key 'GenericName[en_US]' --set-value 'Word Processor' --set-key 'GenericName[zh_CN]' --set-value '电子文档' \
    --set-generic-name 'Create and edit text and graphics in letters, reports, documents and Web pages by using Writer' --set-key 'Comment[en_US]' --set-value 'Create and edit text and graphics in letters, reports, documents and Web pages by using Writer' --set-key 'Comment[zh_CN]' --set-value '使用 Writer 对信函、报告、文档以及网页中的文字和图像进行编辑' \
    --remove-key 'Categories' --add-category 'Office;' \
...
[ -f /usr/share/applications/org.kde.okular.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Document Viewer' --set-key 'GenericName[en_US]' --set-value 'Document Viewer' --set-key 'GenericName[zh_CN]' --set-value '通用文档浏览器' \
    --set-generic-name 'Universal document viewer' --set-key 'Comment[en_US]' --set-value 'Universal document viewer' --set-key 'Comment[zh_CN]' --set-value '通用文档查看器' \
    --remove-key 'Categories' --add-category 'Office;' \
...
[ -f /usr/share/applications/org.kde.kcalc.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Scientific Calculator' --set-key 'GenericName[en_US]' --set-value 'Scientific Calculator' --set-key 'GenericName[zh_CN]' --set-value '科学计算器' \
...
[ -f /usr/share/applications/org.gnome.Meld.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Diff Viewer' --set-key 'GenericName[en_US]' --set-value 'Diff Viewer' --set-key 'GenericName[zh_CN]' --set-value '文件比较工具' \
    --set-generic-name 'Compare and merge your files' --set-key 'Comment[en_US]' --set-value 'Compare and merge your files' --set-key 'Comment[zh_CN]' --set-value '文件比较和整合工具' \
    --remove-key 'Categories' --add-category 'Office;' \
...
[ -f /usr/share/applications/cider.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Apple Music' --set-key 'GenericName[en_US]' --set-value 'Apple Music' --set-key 'GenericName[zh_CN]' --set-value '苹果音乐客户端' \
    --set-generic-name 'Open-source Apple Music Client' --set-key 'Comment[en_US]' --set-value 'Open-source Apple Music Client' --set-key 'Comment[zh_CN]' --set-value '开源苹果音乐客户端' \
...
[ -f /usr/share/applications/com.interversehq.qView.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Image Viewer' --set-key 'GenericName[en_US]' --set-value 'Image Viewer' --set-key 'GenericName[zh_CN]' --set-value '图片浏览工具' \
    --set-generic-name 'Practical and Minimal Image Viewer' --set-key 'Comment[en_US]' --set-value 'Practical and Minimal Image Viewer' --set-key 'Comment[zh_CN]' --set-value '简易图像查看器' \
...
[ -f /usr/share/applications/vlc.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Media player' --set-key 'GenericName[en_US]' --set-value 'Media player' --set-key 'GenericName[zh_CN]' --set-value '多媒体播放器' \
    --set-generic-name 'Read, capture, broadcast your multimedia streams' --set-key 'Comment[en_US]' --set-value 'Read, capture, broadcast your multimedia streams' --set-key 'Comment[zh_CN]' --set-value '读取、捕获、广播您的多媒体流' \
    --remove-key 'Categories' --add-category 'AudioVideo;' \
...
[ -f /usr/share/applications/org.kde.gwenview.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Image Manager' --set-key 'GenericName[en_US]' --set-value 'Image Manager' --set-key 'GenericName[zh_CN]' --set-value '图片管理工具' \
    --set-generic-name 'A simple image viewer' --set-key 'Comment[en_US]' --set-value 'A simple image viewer' --set-key 'Comment[zh_CN]' --set-value '简易图像查看管理器' \
    --remove-key 'Categories' --add-category 'AudioVideo;' \
...
[ -f /usr/share/applications/org.kde.elisa.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Music Player' --set-key 'GenericName[en_US]' --set-value 'Music Player' --set-key 'GenericName[zh_CN]' --set-value '音乐播放器' \
    --set-generic-name 'Organize and Play Music' --set-key 'Comment[en_US]' --set-value 'Organize and Play Music' --set-key 'Comment[zh_CN]' --set-value '整理与播放音乐' \
    --remove-key 'Categories' --add-category 'AudioVideo;' \
...
[ -f /usr/share/applications/org.inkscape.Inkscape.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Vector Graphics Editor' --set-key 'GenericName[en_US]' --set-value 'Vector Graphics Editor' --set-key 'GenericName[zh_CN]' --set-value '矢量图形编辑器' \
    --set-generic-name 'Create and edit Scalable Vector Graphics images' --set-key 'Comment[en_US]' --set-value 'Create and edit Scalable Vector Graphics images' --set-key 'Comment[zh_CN]' --set-value '创建、编辑矢量图形图像' \
    --remove-key 'Categories' --add-category 'AudioVideo;' \
...
[ -f /usr/share/applications/org.kde.krita.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Pixel Images Editor' --set-key 'GenericName[en_US]' --set-value 'Pixel Images Editor' --set-key 'GenericName[zh_CN]' --set-value '点阵图像处理器' \
    --set-generic-name 'Create and Edit Pixel Images' --set-key 'Comment[en_US]' --set-value 'Create and Edit Pixel Images' --set-key 'Comment[zh_CN]' --set-value '创建、编辑点阵图形图像' \
    --remove-key 'Categories' --add-category 'AudioVideo;' \
...
[ -f /usr/share/applications/musescore.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Music Notation' --set-key 'GenericName[en_US]' --set-value 'Music Notation' --set-key 'GenericName[zh_CN]' --set-value '绘谱工具' \
    --set-generic-name 'Create, play and print sheet music' --set-key 'Comment[en_US]' --set-value 'Create, play and print sheet music' --set-key 'Comment[zh_CN]' --set-value '免费易用的绘谱软件' \
...
[ -f /usr/share/applications/org.kde.kamoso.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Camera' --set-key 'GenericName[en_US]' --set-value 'Camera' --set-key 'GenericName[zh_CN]' --set-value '摄像头' \
    --set-generic-name 'Use your webcam to take pictures or make videos' --set-key 'Comment[en_US]' --set-value 'Use your webcam to take pictures or make videos' --set-key 'Comment[zh_CN]' --set-value '使用摄像头照相或者制作视频' \
    --remove-key 'Categories' --add-category 'AudioVideo;' \
...
[ -f /usr/share/applications/org.kde.kdenlive.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Nonlinear Video Editor' --set-key 'GenericName[en_US]' --set-value 'Nonlinear Video Editor' --set-key 'GenericName[zh_CN]' --set-value '非线性视频编辑工具' \
    --set-generic-name 'Nonlinear Video Editor by KDE' --set-key 'Comment[en_US]' --set-value 'Nonlinear Video Editor by KDE' --set-key 'Comment[zh_CN]' --set-value 'KDE社区开发的非线性视频编辑工具' \
    --remove-key 'Categories' --add-category 'AudioVideo;' \
...
[ -f /usr/share/applications/tomorrowcorporation_com-HumanResourceMachine_1.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Programming Game' --set-key 'GenericName[en_US]' --set-value 'Programming Game' --set-key 'GenericName[zh_CN]' --set-value '编程游戏' \
    --set-generic-name 'Learn programming by gaming' --set-key 'Comment[en_US]' --set-value 'Learn programming by gaming' --set-key 'Comment[zh_CN]' --set-value '游戏学习编程' \
...
[ -f /usr/share/applications/org.kde.gcompris.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Educational Game' --set-key 'GenericName[en_US]' --set-value 'Educational Game' --set-key 'GenericName[zh_CN]' --set-value '少儿教学游戏' \
    --set-generic-name 'Multi-Activity Educational game for children 2 to 10' --set-key 'Comment[en_US]' --set-value 'Multi-Activity Educational game for children 2 to 10' --set-key 'Comment[zh_CN]' --set-value '面向2到10岁儿童的多学科教学游戏' \
    --remove-key 'Categories' --add-category 'Game;' \
...
[ -f /usr/share/applications/org.stellarium.Stellarium.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Desktop Planetarium' --set-key 'GenericName[en_US]' --set-value 'Desktop Planetarium' --set-key 'GenericName[zh_CN]' --set-value '桌面天文馆' \
    --set-generic-name 'Planetarium' --set-key 'Comment[en_US]' --set-value 'Planetarium' --set-key 'Comment[zh_CN]' --set-value '天文馆' \
    --remove-key 'Categories' --add-category 'Game;' \
...
[ -f /usr/share/applications/org.kde.bovo.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Five-in-a-row Board Game' --set-key 'GenericName[en_US]' --set-value 'Five-in-a-row Board Game' --set-key 'GenericName[zh_CN]' --set-value '五子棋游戏' \
    --remove-key 'Categories' --add-category 'Game;' \
...
[ -f /usr/share/applications/org.kde.kapman.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Pac-Man Game' --set-key 'GenericName[en_US]' --set-value 'Pac-Man Game' --set-key 'GenericName[zh_CN]' --set-value '街机游戏' \
    --remove-key 'Categories' --add-category 'Game;' \
...
[ -f /usr/share/applications/org.kde.kdiamond.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Three-in-a-row Game' --set-key 'GenericName[en_US]' --set-value 'Three-in-a-row Game' --set-key 'GenericName[zh_CN]' --set-value '休闲游戏' \
    --remove-key 'Categories' --add-category 'Game;' \
...
[ -f /usr/share/applications/org.kde.kigo.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Go Board Game' --set-key 'GenericName[en_US]' --set-value 'Go Board Game' --set-key 'GenericName[zh_CN]' --set-value '围棋游戏' \
    --remove-key 'Categories' --add-category 'Game;' \
...
[ -f /usr/share/applications/onedrivegui.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Cloud Storage' --set-key 'GenericName[en_US]' --set-value 'Cloud Storage' --set-key 'GenericName[zh_CN]' --set-value '云储存空间' \
    --set-generic-name 'OneDrive Client' --set-key 'Comment[en_US]' --set-value 'OneDrive Client' --set-key 'Comment[zh_CN]' --set-value 'OneDrive 客户端' \
...
[ -f /usr/share/applications/wihotspot.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Feature-rich Wifi Hotspot' --set-key 'GenericName[en_US]' --set-value 'Feature-rich Wifi Hotspot' --set-key 'GenericName[zh_CN]' --set-value '共享网络' \
    --remove-key 'Categories' --add-category 'Utility;' \
...
[ -f /usr/share/applications/simplenote.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Note Taking Application' --set-key 'GenericName[en_US]' --set-value 'Note Taking Application' --set-key 'GenericName[zh_CN]' --set-value '极简记事本' \
    --set-generic-name 'Simplenote is an easy way to keep notes' --set-key 'Comment[en_US]' --set-value 'Simplenote is an easy way to keep notes' --set-key 'Comment[zh_CN]' --set-value '极简云同步Markdown笔记软件' \
...
[ -f /usr/share/applications/enpass.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Password Manager' --set-key 'GenericName[en_US]' --set-value 'Password Manager' --set-key 'GenericName[zh_CN]' --set-value '密码管理器' \
    --set-generic-name 'Password Manager and Secure Vault' --set-key 'Comment[en_US]' --set-value 'Password Manager and Secure Vault' --set-key 'Comment[zh_CN]' --set-value '密码管理保险库' \
    --remove-key 'Categories' --add-category 'Utility;' \
...
[ -f /usr/share/applications/balena-etcher.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Bootable USB Creator' --set-key 'GenericName[en_US]' --set-value 'Bootable USB Creator' --set-key 'GenericName[zh_CN]' --set-value '启动盘制作工具' \
    --set-generic-name 'A cross-platform tool to flash OS images onto SD cards and USB drives safely and easily' --set-key 'Comment[en_US]' --set-value 'A cross-platform tool to flash OS images onto SD cards and USB drives safely and easily' --set-key 'Comment[zh_CN]' --set-value '简单方便制作U盘启动盘' \
...
[ -f /usr/share/applications/expandrive.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Cloud Drive Mount' --set-key 'GenericName[en_US]' --set-value 'Cloud Drive Mount' --set-key 'GenericName[zh_CN]' --set-value '网盘挂载工具' \
    --set-generic-name 'Fast Network Drive for Cloud Storage' --set-key 'Comment[en_US]' --set-value 'Fast Network Drive for Cloud Storage' --set-key 'Comment[zh_CN]' --set-value '高速网盘连接' \
    --remove-key 'Categories' --add-category 'Utility;' \
...
[ -f /usr/share/applications/ipscan.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Fast network scanner' --set-key 'GenericName[en_US]' --set-value 'Fast network scanner' --set-key 'GenericName[zh_CN]' --set-value '网络扫描工具' \
    --set-generic-name 'Open-source and Cross-platform Netwdisplay-im7.q16.desktopork Scanner' --set-key 'Comment[en_US]' --set-value 'Open-source and Cross-platform Network Scanner' --set-key 'Comment[zh_CN]' --set-value '开源跨平台IP扫描工具' \
    --remove-key 'Categories' --add-category 'Utility;' \
...
[ -f /usr/share/applications/ukuu-gtk.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Kernel Update Utility' --set-key 'GenericName[en_US]' --set-value 'Kernel Update Utility' --set-key 'GenericName[zh_CN]' --set-value 'Linux内核管理工具' \
    --set-generic-name 'Manage and Update Linux Kernel' --set-key 'Comment[en_US]' --set-value 'Manage and Update Linux Kernel' --set-key 'Comment[zh_CN]' --set-value '管理及更新Linux系统内核' \
    --remove-key 'Categories' --add-category 'Utility;' \
...
[ -f /usr/share/applications/baqpaq-gtk.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Data Backup Tool' --set-key 'GenericName[en_US]' --set-value 'Data Backup Tool' --set-key 'GenericName[zh_CN]' --set-value '文件备份工具' \
    --set-generic-name 'Backup Personal Files' --set-key 'Comment[en_US]' --set-value 'Backup Personal Files' --set-key 'Comment[zh_CN]' --set-value '备份个人文件' \
    --remove-key 'Categories' --add-category 'Utility;' \
...
[ -f /usr/share/applications/modem-manager-gui.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Broadband Network' --set-key 'GenericName[en_US]' --set-value 'Broadband Network' --set-key 'GenericName[zh_CN]' --set-value '移动数据流量' \
    --set-generic-name 'Mobile Broadband Internet' --set-key 'Comment[en_US]' --set-value 'Mobile Broadband Internet' --set-key 'Comment[zh_CN]' --set-value '设置并使用蜂窝数据' \
    --remove-key 'Categories' --add-category 'Utility;' \
...
[ -f /usr/share/applications/org.kde.spectacle.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Screenshot Utility' --set-key 'GenericName[en_US]' --set-value 'Screenshot Utility' --set-key 'GenericName[zh_CN]' --set-value '屏幕截图' \
    --set-generic-name 'Screenshot Capture Utility' --set-key 'Comment[en_US]' --set-value 'Screenshot Capture Utility' --set-key 'Comment[zh_CN]' --set-value '屏幕截图工具' \
    --remove-key 'Categories' --add-category 'Utility;' \
...
[ -f /usr/share/applications/org.kde.partitionmanager.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Disk Partition Editor' --set-key 'GenericName[en_US]' --set-value 'Disk Partition Editor' --set-key 'GenericName[zh_CN]' --set-value '磁盘分区工具' \
...
[ -f /usr/share/applications/solaar.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Logitech Peripherals Manager' --set-key 'GenericName[en_US]' --set-value 'Logitech Peripherals Manager' --set-key 'GenericName[zh_CN]' --set-value '罗技外设管理工具' \
    --set-generic-name 'Logitech Peripherals Manager' --set-key 'Comment[en_US]' --set-value 'Logitech Peripherals Manager' --set-key 'Comment[zh_CN]' --set-value '罗技外设管理工具' \
    --remove-key 'Categories' --add-category 'Utility;' \
...
[ -f /usr/share/applications/davmail.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Microsoft Exchange Gateway' --set-key 'GenericName[en_US]' --set-value 'Microsoft Exchange Gateway' --set-key 'GenericName[zh_CN]' --set-value '微软Exchange网关' \
    --set-generic-name 'POP/IMAP/SMTP/Caldav/Carddav/LDAP Exchange Gateway' --set-key 'Comment[en_US]' --set-value 'POP/IMAP/SMTP/Caldav/Carddav/LDAP Exchange Gateway' --set-key 'Comment[zh_CN]' --set-value 'POP/IMAP/SMTP/Caldav/Carddav/LDAP Exchange 网关' \
    --remove-key 'Categories' --add-category 'Utility;' \
...
[ -f /usr/share/applications/systemsettings.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'System Settings' --set-key 'GenericName[en_US]' --set-value 'System Settings' --set-key 'GenericName[zh_CN]' --set-value '系统设置管理工具' \
    --set-generic-name 'Configuration Tool for the System' --set-key 'Comment[en_US]' --set-value 'Configuration Tool for the System' --set-key 'Comment[zh_CN]' --set-value '管理系统设置' \
...
[ -f /usr/share/applications/org.kde.kinfocenter.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'System Information' --set-key 'GenericName[en_US]' --set-value 'System Information' --set-key 'GenericName[zh_CN]' --set-value '系统信息' \
    --set-generic-name 'System Information Center' --set-key 'Comment[en_US]' --set-value 'System Information Center' --set-key 'Comment[zh_CN]' --set-value '系统信息中心' \
    --remove-key 'Categories' --add-category 'System;' \
...
[ -f /usr/share/applications/org.kde.plasma-systemmonitor.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'System Resource Usage' --set-key 'GenericName[en_US]' --set-value 'System Resource Usage' --set-key 'GenericName[zh_CN]' --set-value '系统资源管理器' \
...
[ -f /usr/share/applications/org.kde.dolphin.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'File Manager' --set-key 'GenericName[en_US]' --set-value 'File Manager' --set-key 'GenericName[zh_CN]' --set-value '文件管理器' \
    --set-generic-name 'KDE File Manager' --set-key 'Comment[en_US]' --set-value 'KDE File Manager' --set-key 'Comment[zh_CN]' --set-value 'KDE文件管理器' \
...
[ -f /usr/share/applications/org.kde.discover.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Software Center' --set-key 'GenericName[en_US]' --set-value 'Software Center' --set-key 'GenericName[zh_CN]' --set-value '软件管理中心' \
    --set-generic-name 'KDE Software Manager' --set-key 'Comment[en_US]' --set-value 'KDE Software Manager' --set-key 'Comment[zh_CN]' --set-value 'KDE软件管理工具' \
    --remove-key 'Categories' --add-category 'System;' \
...
[ -f /usr/share/applications/org.kde.konsole.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Terminal' --set-key 'GenericName[en_US]' --set-value 'Terminal' --set-key 'GenericName[zh_CN]' --set-value '命令行工具' \
    --set-generic-name 'Command Line Tool' --set-key 'Comment[en_US]' --set-value 'Command Line Tool' --set-key 'Comment[zh_CN]' --set-value '终端模拟器' \
    --remove-key 'Categories' --add-category 'System;' \
...
[ -f /usr/share/applications/org.kde.kwrite.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Text Editor' --set-key 'GenericName[en_US]' --set-value 'Text Editor' --set-key 'GenericName[zh_CN]' --set-value '文本编辑工具' \
    --set-generic-name 'KDE Text Editor' --set-key 'Comment[en_US]' --set-value 'KDE Text Editor' --set-key 'Comment[zh_CN]' --set-value 'KDE文本编辑工具' \
    --remove-key 'Categories' --add-category 'System;' \
...
[ -f /usr/share/applications/org.kde.ark.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment 'Archiving Tool' --set-key 'GenericName[en_US]' --set-value 'Archiving Tool' --set-key 'GenericName[zh_CN]' --set-value '压缩文件管理工具' \
    --set-generic-name 'Work with file archives' --set-key 'Comment[en_US]' --set-value 'Work with file archives' --set-key 'Comment[zh_CN]' --set-value '管理压缩包文件' \
    --remove-key 'Categories' --add-category 'System;' \
...
[ -f /usr/share/applications/org.kde.khelpcenter.desktop ] && sudo desktop-file-edit \
    ...
    --set-comment '' --set-key 'GenericName[en_US]' --set-value '' --set-key 'GenericName[zh_CN]' --set-value '' \
    --set-generic-name '' --set-key 'Comment[en_US]' --set-value '' --set-key 'Comment[zh_CN]' --set-value '' \
